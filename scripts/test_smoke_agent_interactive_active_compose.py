...
class InteractiveAgentActiveComposeSmokeTest(unittest.TestCase):
    def test_smoke_is_isolated_and_requires_explicit_active_profiles(self) -> None:
        ...
        self.assertIn('http://core:8081/api/v1/auth/register', script)
        ...
        self.assertIn('JSON_UNQUOTE(JSON_EXTRACT(permissions_json', script)
        self.assertIn('JSON_UNQUOTE(JSON_EXTRACT(scopes_json', script)
