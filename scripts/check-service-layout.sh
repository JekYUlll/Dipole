...
for agent_application in agent_approval_grant.go agent_approval_service.go agent_task_control.go agent_definition_catalog.go agent_memory_candidate_promotion.go agent_task_workflow_projection.go; do
