...
const page = {
  files: [
    { file_id: 'F-HANDOFF-01', file_name: 'platform-handoff.md', file_size: 18_432, content_type: 'text/markdown', created_at: '2026-08-31T08:30:00.000Z', download_path: '/api/v1/files/F-HANDOFF-01/download' },
    { file_id: 'F-ARCHIVE-02', file_name: 'sync-window-report.pdf', file_size: 2_097_152, content_type: 'application/pdf', created_at: '2026-08-30T16:20:00.000Z', download_path: '/api/v1/files/F-ARCHIVE-02/download' },
  ],
  has_more: false,
}
...
test('keeps the owner-scoped File Directory aligned with the V3 disclosure boundary', async ({ page: browserPage }) => {
