<template>
  <section class="memory-shell" :data-agent-memory-state="viewState" :aria-busy="busy">
    ...
    <main class="memory-main">
      <div class="mobile-brandbar"><img class="brand-mark" :src="agentMark" alt="" aria-hidden="true" /><span>长期记忆</span><small>AUTO WRITE OFF</small></div>
