...
.digest { margin-top: 1rem; overflow: hidden; }.digest-header { display: flex; justify-content: space-between; align-items: flex-start; gap: 1rem; padding: 1rem 1.2rem; border-bottom: 1px solid var(--dp-line); background: linear-gradient(120deg, var(--dp-accent-soft), var(--dp-surface)); }.digest-header p { margin: 0 0 .35rem; color: var(--dp-accent-strong); font: 700 .68rem var(--dp-font-data); letter-spacing: .1em; }.digest-header h2, .digest-unsupported h2 { margin: 0; font: 750 1.15rem/1.25 var(--dp-font-display); }.digest-header span { border: 1px solid var(--dp-accent-strong); border-radius: 99px; padding: .3rem .5rem; color: var(--dp-accent-strong); font: 700 .64rem var(--dp-font-data); letter-spacing: .06em; }.digest-body { box-sizing: border-box; width: 100%; min-height: 14rem; margin: 0; padding: 1.25rem; overflow-x: auto; white-space: pre-wrap; overflow-wrap: anywhere; color: var(--dp-ink); font: .94rem/1.75 var(--dp-font-body); }.digest-state { min-height: 8rem; padding: 1.25rem; display: flex; align-items: center; justify-content: space-between; gap: 1rem; color: var(--dp-ink-soft); }.digest-state p { margin: .4rem 0 0; }.digest-state-danger strong { color: var(--dp-danger); }.digest-unsupported { padding: 1rem 1.2rem; }
