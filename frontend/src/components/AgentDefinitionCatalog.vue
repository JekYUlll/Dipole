  ...
  <section class="definition-shell" :data-agent-definition-state="viewState" :aria-busy="busy">
    ...
    <main class="definition-main">
      <header class="page-header">
        ...
        <div class="catalog-status">◌ <strong>CATALOG ONLY</strong></div>
      </header>

      <div class="boundary-notice" role="note">
        <strong>RUNTIME DISABLED</strong>
        <span>浏览 Definition、版本和 scope 不会启用订阅、模型、Tool 或共享事件 Runtime。</span>
      </div>
      ...
      <template v-else>
        ...
        <div class="content-grid">
          ...
          <aside class="authority-panel">
            ...
            <dl><dt>WRITE</dt><dd>disabled</dd><dt>RUNTIME</dt><dd>disabled</dd><dt>SCOPE</dt><dd>server owned</dd></dl>
