...
function runtimeConfig(database: string, topicPrefix: string, groupId: string): ShadowRuntimeConfig {
  ...
  return {
    ...
    groupId, topic: "message.direct.created", groupTopic: "message.group.created", topicPrefix, failureMaxAttempts: 2, topicPartitions: 1,
    ...
    inboundInteractiveEnabled: false, inboundGroupInteractiveEnabled: false,
    mentionAliases: ["AI"], assistantNickname: "Dipole AI",
