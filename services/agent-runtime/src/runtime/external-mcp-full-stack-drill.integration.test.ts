...
function runtimeConfig(database: string, topicPrefix: string, groupId: string): ShadowRuntimeConfig {
  ...
  return {
    ...
    ledgerMode: "mysql", leaseMs: 5_000, modelMode: "metadata", modelProvider: { kind: "disabled", name: "", baseURL: "", apiKey: "", supportsStructuredOutputs: false, outputMode: "json_schema" }, modelRoutes: [], contextCompilerVersion: "v1",
