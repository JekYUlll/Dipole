...
const temporalRuntimeConfigSchema = z.object({
  ...
  activityMode: z.enum(["foundation", "persistent_shadow", "read_shadow", "read_active", "subscription_active", "interactive_active", "retrieval_active", "promotion_active", "external_mcp_shadow"])
}).strict();
