...
func (c *AgentArtifactClient) Get(ctx context.Context, principalUUID, artifactID string) (*AgentArtifact, error) {
	...
	return &AgentArtifact{ArtifactID: raw.GetArtifactId(), TaskID: raw.GetTaskId(), RunID: raw.GetRunId(), ArtifactType: raw.GetArtifactType(),
		Version: raw.GetVersion(), Title: raw.GetTitle(), MediaType: raw.GetMediaType(), ContentSHA256: raw.GetContentSha256(), SizeBytes: raw.GetSizeBytes(), CreatedAtUnixMS: raw.GetCreatedAtUnixMs()}, nil
}
