...
func RegisterHandlers(hub RealtimeHub, authority realtimeDelivery.Authority, fence realtimeDelivery.AuthorityFence) error {
	...
	platformKafka.Subscriber.Register("group.created", NewGroupEventHandler(hub, wsTransport.TypeGroupCreated, func(p service.GroupEventPayload) wsTransport.GroupCreatedEventData {
	...
	platformKafka.Subscriber.Register("group.updated", NewGroupEventHandler(hub, wsTransport.TypeGroupUpdated, func(p service.GroupEventPayload) wsTransport.GroupUpdatedEventData {
	...
	platformKafka.Subscriber.Register("group.members.added", NewGroupEventHandler(hub, wsTransport.TypeGroupMembersAdded, func(p service.GroupEventPayload) wsTransport.GroupMembersChangedEventData {
	...
	platformKafka.Subscriber.Register("group.members.removed", NewGroupEventHandler(hub, wsTransport.TypeGroupMembersRemoved, func(p service.GroupEventPayload) wsTransport.GroupMembersChangedEventData {
		return wsTransport.GroupMembersChangedEventData{GroupUUID: p.GroupUUID, MemberUUIDs: p.MemberUUIDs, OperatorUUID: p.OperatorUUID, OccurredAt: p.OccurredAt}
	}))
	platformKafka.Subscriber.Register("group.dismissed", NewGroupEventHandler(hub, wsTransport.TypeGroupDismissed, func(p service.GroupEventPayload) wsTransport.GroupDismissedEventData {
