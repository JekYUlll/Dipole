...
type Querier interface {
	...
	GetAgentOAuthTokenLifecycleMaintenanceLease(ctx context.Context, handoffUuid string) (AgentOauthTokenLifecycleMaintenanceLease, error)
	...
	InsertAgentOAuthTokenLifecycleMaintenanceLease(ctx context.Context, arg InsertAgentOAuthTokenLifecycleMaintenanceLeaseParams) (int64, error)
	...
	ReclaimExpiredAgentOAuthTokenLifecycleMaintenanceLease(ctx context.Context, arg ReclaimExpiredAgentOAuthTokenLifecycleMaintenanceLeaseParams) (int64, error)
