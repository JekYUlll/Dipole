...
REVOKE ALL PRIVILEGES, GRANT OPTION FROM 'dipole_message_projector'@'%';

GRANT SELECT, INSERT ON dipole.messages TO 'dipole_message_projector'@'%';
...
GRANT SELECT, INSERT, UPDATE ON dipole.outbox_events TO 'dipole_message_projector'@'%';
