...
- **现状：** schema 已由版本化 SQL migration 管理，运行时默认关闭 `AutoMigrate`；AICallLog、Admin、File、User、Contact、Group、Conversation 和 Outbox Relay 已具备 sqlc adapter 与 GORM 回切路径。Message/Sync 写事务与 Outbox Producer 仍直接耦合 GORM，以维持三者当前的原子提交边界。
